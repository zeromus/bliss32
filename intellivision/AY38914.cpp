...
void AY38914::setPSGController0(PSGController* io0)
{
    this->psgIO0 = io0;
}

void AY38914::setPSGController1(PSGController* io1)
{
    this->psgIO1 = io1;
}

void AY38914::init(AudioOutputLine* aol, INT32 location, PSGController* io0, PSGController* io1)
{
    this->aol = aol;
    this->psgIO0 = io0;
    this->psgIO1 = io1;
    registers.init(this, location);
}
...
/**
 * Tick the AY38910.  This method has been profiled over and over again
 ...
 *
 * @return the number of ticks used by the AY38910, always returns 4.
 */
INT32 AY38914::tick()
{
    ...
    //output sample for the entire AY38910
    ...
    aol->playSample(cachedTotalOutput);
